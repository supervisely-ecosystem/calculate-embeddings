...
load_progress = sly.app.widgets.Progress()
load_progress.hide()


def build_model(model_name: str, device: str, model_data: dict, jit=False):
...
def infer_batch(model: open_clip.CLIP, input_images):
